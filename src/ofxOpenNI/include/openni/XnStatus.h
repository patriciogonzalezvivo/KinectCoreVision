 ...
 */
XN_C_API const XnChar* XN_C_DECL xnGetStatusString(const XnStatus TheStatus);
...
*/
XN_C_API const XnChar* XN_C_DECL xnGetStatusName(const XnStatus TheStatus);
...
*
*/
XN_C_API void XN_C_DECL xnPrintError(const XnStatus TheStatus, const XnChar* csUserMessage);
